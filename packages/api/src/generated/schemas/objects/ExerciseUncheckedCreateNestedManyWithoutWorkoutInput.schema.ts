...
const Schema: z.ZodType<Prisma.ExerciseUncheckedCreateNestedManyWithoutWorkoutInput> =
  z
    .object({
      create: z
        .union([
...
export const ExerciseUncheckedCreateNestedManyWithoutWorkoutInputObjectSchema =
  Schema;
