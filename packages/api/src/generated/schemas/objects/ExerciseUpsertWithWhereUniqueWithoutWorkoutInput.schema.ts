...
const Schema: z.ZodType<Prisma.ExerciseUpsertWithWhereUniqueWithoutWorkoutInput> = z
    .object({
...
export const ExerciseUpsertWithWhereUniqueWithoutWorkoutInputObjectSchema = Schema;
