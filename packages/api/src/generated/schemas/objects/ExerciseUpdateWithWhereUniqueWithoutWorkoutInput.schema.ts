...
const Schema: z.ZodType<Prisma.ExerciseUpdateWithWhereUniqueWithoutWorkoutInput> = z
    .object({
...
export const ExerciseUpdateWithWhereUniqueWithoutWorkoutInputObjectSchema = Schema;
