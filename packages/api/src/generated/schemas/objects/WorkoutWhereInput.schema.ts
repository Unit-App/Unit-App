...
const Schema: z.ZodType<Prisma.WorkoutWhereInput> = z
    .object({
        AND: z
            .union([z.lazy(() => WorkoutWhereInputObjectSchema), z.lazy(() => WorkoutWhereInputObjectSchema).array()])
            .optional(),
        OR: z
        ...
        lastPreformed: z.union([z.lazy(() => StringFilterObjectSchema), z.string()]).optional(),
