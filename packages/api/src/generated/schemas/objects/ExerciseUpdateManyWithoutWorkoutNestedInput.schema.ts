...
const Schema: z.ZodType<Prisma.ExerciseUpdateManyWithoutWorkoutNestedInput> = z
  .object({
    create: z
      .union([
...
export const ExerciseUpdateManyWithoutWorkoutNestedInputObjectSchema = Schema;
