...
const Schema: z.ZodType<Prisma.ExerciseUncheckedUpdateManyWithoutWorkoutNestedInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => ExerciseUncheckedCreateWithoutWorkoutInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => ExerciseCreateOrConnectWithoutWorkoutInputObjectSchema)
            .array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(
            () => ExerciseUpsertWithWhereUniqueWithoutWorkoutInputObjectSchema,
          ),
          z
            .lazy(
              () =>
        ...
        .optional(),
      createMany: z
        .lazy(() => ExerciseCreateManyWorkoutInputEnvelopeObjectSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(
            () => ExerciseUpdateWithWhereUniqueWithoutWorkoutInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ExerciseUpdateManyWithWhereWithoutWorkoutInputObjectSchema,
          ),
          z
            .lazy(
              () => ExerciseUpdateManyWithWhereWithoutWorkoutInputObjectSchema,
...
export const ExerciseUncheckedUpdateManyWithoutWorkoutNestedInputObjectSchema =
  Schema;
