...
const Schema: z.ZodType<Prisma.ExerciseWhereInput> = z
    .object({
        AND: z
            .union([z.lazy(() => ExerciseWhereInputObjectSchema), z.lazy(() => ExerciseWhereInputObjectSchema).array()])
            .optional(),
        OR: z
        ...
        workout: z
            .union([z.lazy(() => WorkoutRelationFilterObjectSchema), z.lazy(() => WorkoutWhereInputObjectSchema)])
            .optional()
            .nullable(),
        created_at: z
