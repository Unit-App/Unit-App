...
export const WorkoutUpsertSchema = z.object({
    ...
    create: z.union([WorkoutCreateInputObjectSchema, WorkoutUncheckedCreateInputObjectSchema]),
    update: z.union([WorkoutUpdateInputObjectSchema, WorkoutUncheckedUpdateInputObjectSchema]),
});
