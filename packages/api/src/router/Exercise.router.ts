...
export const exercisesRouter = t.router({
    ...
    createManyExercise: shieldedProcedure.input(ExerciseCreateManySchema).mutation(async ({ ctx, input }) => {
        const createManyExercise = await ctx.prisma.exercise.createMany(input);
        return createManyExercise;
    }),
    createOneExercise: shieldedProcedure.input(ExerciseCreateOneSchema).mutation(async ({ ctx, input }) => {
        const createOneExercise = await ctx.prisma.exercise.create(input);
        return createOneExercise;
    }),
    deleteManyExercise: shieldedProcedure.input(ExerciseDeleteManySchema).mutation(async ({ ctx, input }) => {
        const deleteManyExercise = await ctx.prisma.exercise.deleteMany(input);
        return deleteManyExercise;
    }),
    deleteOneExercise: shieldedProcedure.input(ExerciseDeleteOneSchema).mutation(async ({ ctx, input }) => {
        const deleteOneExercise = await ctx.prisma.exercise.delete(input);
        return deleteOneExercise;
    }),
    findFirstExercise: shieldedProcedure.input(ExerciseFindFirstSchema).query(async ({ ctx, input }) => {
        const findFirstExercise = await ctx.prisma.exercise.findFirst(input);
        return findFirstExercise;
    }),
    findFirstExerciseOrThrow: shieldedProcedure.input(ExerciseFindFirstSchema).query(async ({ ctx, input }) => {
        const findFirstExerciseOrThrow = await ctx.prisma.exercise.findFirstOrThrow(input);
        return findFirstExerciseOrThrow;
    }),
    findManyExercise: shieldedProcedure.input(ExerciseFindManySchema).query(async ({ ctx, input }) => {
        const findManyExercise = await ctx.prisma.exercise.findMany(input);
        return findManyExercise;
    }),
    findUniqueExercise: shieldedProcedure.input(ExerciseFindUniqueSchema).query(async ({ ctx, input }) => {
        const findUniqueExercise = await ctx.prisma.exercise.findUnique(input);
        return findUniqueExercise;
    }),
    findUniqueExerciseOrThrow: shieldedProcedure.input(ExerciseFindUniqueSchema).query(async ({ ctx, input }) => {
        const findUniqueExerciseOrThrow = await ctx.prisma.exercise.findUniqueOrThrow(input);
        return findUniqueExerciseOrThrow;
    }),
    groupByExercise: shieldedProcedure.input(ExerciseGroupBySchema).query(async ({ ctx, input }) => {
        const groupByExercise = await ctx.prisma.exercise.groupBy({
            where: input.where,
    ...
    updateManyExercise: shieldedProcedure.input(ExerciseUpdateManySchema).mutation(async ({ ctx, input }) => {
        const updateManyExercise = await ctx.prisma.exercise.updateMany(input);
        return updateManyExercise;
    }),
    updateOneExercise: shieldedProcedure.input(ExerciseUpdateOneSchema).mutation(async ({ ctx, input }) => {
        const updateOneExercise = await ctx.prisma.exercise.update(input);
        return updateOneExercise;
    }),
    upsertOneExercise: shieldedProcedure.input(ExerciseUpsertSchema).mutation(async ({ ctx, input }) => {
